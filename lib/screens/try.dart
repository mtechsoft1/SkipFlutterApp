...
import 'package:task_rabbit/widgets/home_screen_table.dart';
        ...
        Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Container(
                    width: screenWidth * 0.8, // Match the width of the parent
...
//become a provider
        ...
        Container(
          ...
          child: Text('Popular projects'),
        ),
        Container(
            height: screenHeight * 0.55,
            width: screenWidth,
            color: Colors.blueAccent,
            child: Text('Who we Work')),
        Container(
