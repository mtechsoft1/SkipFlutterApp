...
import 'package:task_rabbit/widgets/bottom_navigation_bar.dart';
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          color: Colors.white,
                          fontSize:
                              DeviceDimensions.responsiveSize(context) * 0.02,
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 20, // Diameter of the circular container
                            height: 20,
                            decoration: BoxDecoration(
                                shape: BoxShape.circle,
                ...
                children: const [
                  TableRow(
                    children: [
                      ...
                      PopularProjectsWidget(
                        imagePath: 'assets/images/mounting_art_shelves.png',
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                BottomNavBar(0, 'assets/images/home_nav_icon.png'),
                BottomNavBar(1, 'assets/images/service_nav_icon.png'),
                BottomNavBar(2, 'assets/images/activity_nav_icon.png'),
                BottomNavBar(3, 'assets/images/account_nav_icon.png'),
              ],
            ),
          ),
        ),
